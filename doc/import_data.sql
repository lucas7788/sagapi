...
insert into tbl_api_tag (ApiId, TagId,State) values (3,10,1);
...
insert into tbl_specifications (ApiId,Price,Amount) values (3,'0',50);
insert into tbl_specifications (ApiId,Price,Amount) values (3,'0.1',100);
insert into tbl_specifications (ApiId,Price,Amount) values (3,'0.075',200);
...
insert into tbl_tool_box (Title,Coin,Price,ToolBoxDesc,ToolBoxType,Icon) values ('Weather Forecast','ONG','2','Get weather forecast for a city by analyzing historical data collected from worldwide weather stations','toolbox','https://dev4.sagamarket.io/img/icons/tianqi.svg');
insert into tbl_tool_box_tag (ToolBoxId, TagId,State) values (1,14,1);
insert into tbl_api_header_values (ApiId, HeaderKey,HeaderValue) values (3,"Authorization","4cdb5582-90d8-11ea-af71-0242ac130002-4cdb5640-90d8-11ea-af71-0242ac130002");
