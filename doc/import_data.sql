...
insert into tbl_api_basic_info (Coin,ApiType,Icon, Title, ApiProvider, ApiSagaUrlKey, ApiUrl, Price, ApiDesc,Specifications,Popularity,Delay,SuccessRate,InvokeFrequency,ApiState,RequestType, Mark, ResponseParam, ResponseExample, DataDesc, DataSource,ApplicationScenario,ApiKind) values ('ONG','data_process_wether','https://dev4.sagamarket.io/img/icons/Geography.svg','weather','https://api.stormglass.io/v2/weather/point?params=airTemperature','sagaurl_7d07a1fa-95da-11ea-9c30-5f81df211d0b','https://dev3.sagamarket.io/api/v1/data_source/sagaurl_7d07a1fa-95da-11ea-9c30-5f81df211d0b/:apikey','0','get wether data',1,100,0,100,0,1,'GET','mark','ResponseParam','{"hours":[{"airTemperature":{"noaa":22.26,"sg":22.26},"time":"2020-05-02T00:00:00+00:00"}]}','airTemperature','Stormglass','',2);
...
insert into tbl_algorithm (AlgName, Provider, Description, Price, Coin) values ('storm gass predictor', 'Ontology','a prediction of wether','0.1','ONG');
insert into tbl_env (EnvName, Provider, Description, Price, Coin) values ('normal server', 'Ontology', 'a linux server', '0.1', 'ONG');
